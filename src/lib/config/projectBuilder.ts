...
function validateParsedProjectBuilderConfig(
  ...
  if (typeof parsed.infra !== "undefined") {
    return `Invalid config '${configPath}': legacy 'infra' block is no longer supported. Use deploy.yaml for deployment configuration.`;
  }
